...
void PacketResourceWatcher::HandleFileAction(FW::WatchID _watchid, const FW::String& _dir, const FW::String& _filename, FW::Action _action)
{
	...
	{
	case FW::Actions::Add:
		std::cout << "File (" << _dir + "\\" + _filename << ") Added! " << std::endl << std::endl;
		break;
	case FW::Actions::Delete:
		std::cout << "File (" << _dir + "\\" + _filename << ") Deleted! " << std::endl << std::endl;
		break;
	case FW::Actions::Modified:
		std::cout << "File (" << _dir + "\\" + _filename << ") Modified! " << std::endl << std::endl;
